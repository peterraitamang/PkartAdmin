...
import kotlinproject.pkartadmin.databinding.FragmentSliderBinding
...
class SliderFragment : Fragment() {
    ...
    private var launchGalleryActivity = registerForActivityResult(
        ...
        if (it.resultCode == Activity.RESULT_OK){
            ...
            binding.imgNoImage.setImageURI(imageUrl)
        }
    }
    ...
    private fun storeData(image: String) {
        ...
        db.collection("slider").document("item").set(data)
            .addOnSuccessListener {
                dialog.dismiss()
                binding.imgNoImage.setImageDrawable(resources.getDrawable(R.drawable.imagepreview))
