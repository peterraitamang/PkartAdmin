...
import kotlinproject.pkartadmin.adapter.CategoryAdapter
import kotlinproject.pkartadmin.databinding.FragmentCategoryBinding
...
class CategoryFragment : Fragment() {
    ...
    private var launchGalleryActivity = registerForActivityResult(
        ...
        if (it.resultCode == Activity.RESULT_OK){
            ...
            binding.imgUploadCategoryImage.setImageURI(imageUrl)
        }
    }
    ...
    override fun onCreateView(
        ...
        binding.apply {
            imgUploadCategoryImage.setOnClickListener{
            ...
            btnUploadCategory.setOnClickListener{
                validateData(binding.txtCategoryName.text.toString())
    ...
    private fun storeData(categoryName: String, url: String) {
        ...
        db.collection("categories").add(data)
            .addOnSuccessListener {
                dialog.dismiss()
                binding.imgUploadCategoryImage.setImageDrawable(resources.getDrawable(R.drawable.imagepreview))
